...
val errorContainerDark = Color(0xFFADADAD)
val onErrorContainerDark = Color(0xFFEF5350)
val backgroundDark = Color(0xFF000000)
val onBackgroundDark = Color(0xFFADADAD)
val surfaceDark = Color(0xFF000000)
val onSurfaceDark = Color(0xFFD3C8C9)
val surfaceVariantDark = Color(0xFF4C4546)
val onSurfaceVariantDark = Color(0xFFADADAD)
